  ...
  <section className="py-3 md:py-20 bg-white dark:bg-transparent">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 md:border md:border-gray-300 md:dark:border-white/10 md:rounded-lg md:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-white dark:bg-[#141417] border border-gray-300 dark:border-white/10 rounded-lg shadow-sm dark:bg-[#141417] dark:border-white/10 overflow-hidden animate-pulse">
            <div className="bg-gray-200 dark:bg-white/10 aspect-[16/10]" />
            <div className="p-2 md:p-6">
              <div className="hidden md:flex items-center gap-3 mb-4">
                ...
                <div className="space-y-1.5 flex-1">
                  ...
                  <div className="h-2.5 w-32 bg-gray-200 dark:bg-white/10 rounded" />
                </div>
              </div>
              <div className="h-3 md:h-5 w-3/4 bg-gray-200 dark:bg-white/10 rounded mb-1.5 md:mb-2" />
              <div className="hidden md:block h-3 w-full bg-gray-200 dark:bg-white/10 rounded mb-1.5" />
              <div className="hidden md:block h-3 w-2/3 bg-gray-200 dark:bg-white/10 rounded mb-5" />
              <div className="pt-1.5 md:pt-4 border-t border-gray-100 dark:border-white/5 flex justify-between">
                <div className="h-2 md:h-3 w-12 md:w-16 bg-gray-200 dark:bg-white/10 rounded" />
                <div className="h-2 md:h-3 w-10 md:w-12 bg-gray-200 dark:bg-white/10 rounded" />
              </div>
            </div>
          </div>
        ))}
...
const BlogGrid: React.FC<BlogGridProps> = ({ limit, showViewAll = false }) => {
  ...
  if (error) {
    return (
      <section className="py-3 md:py-20 bg-white dark:bg-transparent">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 md:border md:border-gray-300 md:dark:border-white/10 md:rounded-lg md:p-8">
