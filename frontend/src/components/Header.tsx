          ...
          <div className="relative flex-1" ref={mobileSearchRef}>
            <form onSubmit={handleSearch} className="group relative flex items-center" role="search">
              <input
                ...
                className="w-full pl-4 pr-11 py-2.5 text-sm border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-700 transition-colors"
                aria-label="Search"
              />
              <button
                type="submit"
                className="absolute right-1 p-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-600"
