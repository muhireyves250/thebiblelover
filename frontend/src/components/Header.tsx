          ...
          <div className="relative flex-1" ref={mobileSearchRef}>
            <form onSubmit={handleSearch} className="group relative flex items-center" role="search">
              <input
                ...
                className="w-full pl-4 pr-11 py-2.5 text-sm border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-700 focus:outline-none focus:bg-gray-200 dark:focus:bg-gray-700 transition-colors"
                aria-label="Search"
              />
              <button
                type="submit"
