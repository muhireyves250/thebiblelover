...
const BlogCard: React.FC<BlogCardProps> = ({
  ...
  return (
    <article className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-gray-100/50 transition-all duration-500 ease-out group">
        ...
        <div className="pt-4 border-t border-gray-200 flex items-center justify-between text-[12px] text-gray-500">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              onClick={handleLike}
              disabled={isLiking}
              className={`flex items-center space-x-1 transition-all duration-300 ease-out hover:scale-110 transform ${isLiked
                ? 'text-red-600'
