...
const MobileBottomNav = () => {
  ...
  return (
    <nav
      ...
      aria-label="Primary"
    >
      <div className="relative flex items-stretch justify-around gap-0.5 px-2 bg-white/95 backdrop-blur-xl rounded-t-full rounded-b-none border-2 border-b-0 border-gray-300 shadow-2xl overflow-hidden">
