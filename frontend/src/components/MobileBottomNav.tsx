...
const MobileBottomNav = () => {
  ...
  return (
    <nav
      ...
      aria-label="Primary"
    >
      <div className="relative flex items-stretch justify-around bg-white/95 backdrop-blur-xl rounded-[28px] border-2 border-gray-300 shadow-2xl overflow-hidden">
