...
const BARE_LAYOUT_PATHS = ['/reset-password', '/dashboard'];
...
const PAGE_HEADER_DESKTOP_ONLY_PATHS = ['/prayer-wall', '/watch', '/events', '/about', '/contact', '/login', '/donate', '/terms', '/privacy'];
