            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-16">
                <div className="md:hidden mb-3">
                    <div className="flex items-center gap-2 mb-1.5">
                        <span className="w-1 h-4 bg-amber-700 rounded-sm" />
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-700">Protecting Your Spiritual Data</span>
                    </div>
                    <h1 className="text-2xl font-black uppercase tracking-tight text-gray-900">Privacy Policy</h1>
                </div>
