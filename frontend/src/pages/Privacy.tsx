        ...
        <div className="bg-white min-h-screen">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-16">
                <div className="md:hidden mb-3">
                    ...
                    <AutoText as="h1" className="text-2xl font-black uppercase tracking-tight text-gray-900">Privacy Policy</AutoText>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 mb-4 md:mb-8">
                    <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-4 md:p-6">
                        ...
                        <AutoText as="h3" className="text-sm font-black uppercase tracking-widest text-gray-900 mb-2">Data Collection</AutoText>
                        <AutoText as="p" className="text-sm text-gray-600 leading-relaxed">
                    ...
                    <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-4 md:p-6">
                        ...
                        <AutoText as="h3" className="text-sm font-black uppercase tracking-widest text-gray-900 mb-2">Security First</AutoText>
                        <AutoText as="p" className="text-sm text-gray-600 leading-relaxed">
