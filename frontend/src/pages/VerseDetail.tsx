...
import { Calendar, BookOpen, Languages, Share2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <nav className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-6">
          ...
          <Link to="/verses" className="hover:text-amber-700 transition-colors">Verses</Link>
          <span className="mx-2">/</span>
          {verse ? (
            <span className="text-amber-700">{dayAbbrev(verse.displayDate)}</span>
          ) : (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <article className="lg:col-span-2">
            {showSkeleton ? (
              ...
              <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-6 md:p-8 mb-8">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 pb-6 mb-2 border-b border-gray-200">
                  <p className="text-gray-600 text-lg">
                    {reference(verse)} <span className="text-gray-400 text-base">({verse.translation})</span>
                  </p>
          ...
          <aside className="lg:col-span-1 space-y-6 lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto">
            ...
            <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-5">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-amber-700 mb-4">Verse Details</h3>
              {!verse ? (
            ...
            {recentLoaded && recentVerses.length > 0 && (
              <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-5">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xs font-black uppercase tracking-[0.2em] text-amber-700">Recent Verses</h3>
                  <Link to="/verses" className="text-[10px] font-bold text-amber-700 uppercase tracking-widest hover:text-amber-800 transition-colors">
                    All Verses &rarr;
                  </Link>
                </div>
                <div className="space-y-4">
