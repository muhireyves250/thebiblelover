        ...
        <div className="min-h-screen bg-white dark:bg-transparent">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-16">
                <div className="md:hidden mb-4">
                    ...
                    <AutoText as="h1" className="text-2xl font-black uppercase tracking-tight text-gray-900 dark:text-white">Community Calendar</AutoText>
                    <AutoText as="p" className="text-sm text-gray-500 dark:text-gray-400 mt-2">Join us as we grow together in faith, knowledge, and fellowship.</AutoText>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-3 md:gap-4 items-stretch md:items-center justify-between mb-6 md:mb-10">
                    ...
                    <div className="relative w-full md:w-64">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-white/10 rounded-md text-sm focus:border-amber-600 focus:outline-none transition-colors"
                        />
                    </div>
                </div>
                ...
                {loading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
                        {[1, 2, 3].map(n => (
                            <div key={n} className="bg-white dark:bg-[#141417] border border-gray-300 dark:border-white/10 rounded-lg shadow-sm dark:bg-[#141417] dark:border-white/10 h-[380px] animate-pulse"></div>
                        ))}
                    </div>
                    ...
                    <div className="text-center py-16 bg-white dark:bg-[#141417] border border-dashed border-gray-300 dark:border-white/10 rounded-lg">
                        ...
                        <AutoText as="h3" className="text-lg font-bold text-gray-900 dark:text-white">No events found</AutoText>
                        <AutoText as="p" className="text-gray-500 dark:text-gray-400 text-sm mt-1">Adjust your filters or check back later.</AutoText>
                    </div>
                ) : (
                        ...
                        {pastEvents.length > 0 && (
                            <section className="opacity-75">
                                <div className="flex items-center gap-2 mb-4 md:mb-6">
                                    ...
                                    <AutoText as="h2" className="text-[11px] md:text-xs font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500">Past Events</AutoText>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
...
const EventCard = ({ event, isPast }: { event: Event, isPast?: boolean }) => {
    ...
    return (
        <Link
            to={`/events/${event.id}`}
            className="group bg-white dark:bg-[#141417] border border-gray-300 dark:border-white/10 rounded-lg shadow-sm dark:bg-[#141417] dark:border-white/10 overflow-hidden hover:border-gray-400 hover:shadow-md transition-all flex flex-col h-full"
        >
            ...
            <div className="p-3 md:p-6 flex flex-col flex-1">
                ...
                <h3 className="text-sm md:text-lg font-bold text-gray-900 dark:text-white mb-2 md:mb-3 group-hover:text-amber-700 transition-colors line-clamp-2">
                    {event.title}
                </h3>

                <div className="flex items-center gap-1.5 md:gap-2 text-gray-500 dark:text-gray-400 text-xs md:text-sm mb-3 md:mb-6">
                    <MapPin className="h-3.5 w-3.5 md:h-4 md:w-4 shrink-0" />
                    <span className="truncate">{event.location}</span>
                </div>

                <div className="mt-auto pt-3 md:pt-4 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
                    <div className="flex -space-x-2">
                        {[1, 2, 3].map(n => (
                            <div key={n} className="w-6 h-6 md:w-7 md:h-7 rounded-full border-2 border-white bg-gray-100 dark:bg-white/10 flex items-center justify-center overflow-hidden">
                    ...
                    <span className="p-1.5 md:p-2 border border-gray-200 dark:border-white/10 rounded-full text-gray-400 dark:text-gray-500 group-hover:bg-amber-700 group-hover:border-amber-700 group-hover:text-white transition-colors">
