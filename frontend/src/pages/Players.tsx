        ...
        {loading ? (
          <>
            <div className="md:hidden space-y-2.5">
              {[1, 2, 3, 4, 5, 6].map(i => <div key={i} className="h-[76px] bg-gray-200 animate-pulse rounded-2xl" />)}
            </div>
              ...
              {episodes.map(episode => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-gray-400 mt-0.5">{formatDate(episode.episodeDate)} &middot; {episode.slot}</p>
                  </div>
