            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-16">
                <div className="md:hidden mb-3">
                    <div className="flex items-center gap-2 mb-1.5">
                        <span className="w-1 h-4 bg-amber-700 rounded-sm" />
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-700">Walking Together in Unity</span>
                    </div>
                    <h1 className="text-2xl font-black uppercase tracking-tight text-gray-900">Terms of Service</h1>
                </div>
                ...
                <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-4 md:p-8 mb-4 md:mb-8">
                    ...
                    <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3 md:mb-5">
