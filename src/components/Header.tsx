          ...
          <nav className="hidden md:flex items-center space-x-8 md:space-x-10">
            <Link 
              ...
              className={`text-sm md:text-base tracking-wide transition-colors ${
                location.pathname === '/' ? 'text-amber-700' : 'text-gray-700 hover:text-amber-700'
              }`}
            >
              Home
            </Link>
            <Link 
              to="/about" 
              className={`text-sm md:text-base tracking-wide transition-colors ${
                location.pathname === '/about' ? 'text-amber-700' : 'text-gray-700 hover:text-amber-700'
              }`}
            >
              About
            </Link>
            <Link 
              to="/donate" 
              className={`text-sm md:text-base tracking-wide transition-colors ${
                location.pathname === '/donate' ? 'text-amber-700' : 'text-gray-700 hover:text-amber-700'
              }`}
            >
              Donate
            </Link>
            <Link 
              to="/contact" 
              className={`text-sm md:text-base tracking-wide transition-colors ${
                location.pathname === '/contact' ? 'text-amber-700' : 'text-gray-700 hover:text-amber-700'
              }`}
            >
              Contact
            </Link>
