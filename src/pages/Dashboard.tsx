            ...
            <div className="space-y-3">
              ...
              <button
                ...
                onClick={() => setActiveTab(id)}
                  className={`w-full flex items-center ${sidebarOpen ? 'space-x-4 px-4' : 'justify-center px-2'} py-4 rounded-2xl font-semibold text-sm transition-all duration-300 group ${
                  activeTab === id
              ...
              {settingsDropdownOpen && (
                <div className={`${sidebarOpen ? 'ml-4 mr-4' : 'ml-0 mr-0'} mt-4 space-y-3 bg-gradient-to-br from-gray-50 to-white rounded-2xl p-4 shadow-lg border border-gray-100 relative z-50 w-full max-w-xs`}>
                  <button
                    ...
                    className={`w-full flex items-center space-x-4 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 ${
                      activeTab === 'storage'
